from PyQt6.QtWidgets import QWidget, QTableWidget, QTableWidgetItem, QAbstractItemView, QSizePolicy, QVBoxLayout, QLineEdit
...
class NameListWidget(QWidget):
    ...
    def initUI(self):
        ...
        print(self.sizePolicy(), self.nameTable.sizePolicy())
